...
//#define SX1272_SS 10 //For use with AlbaTracker 1 and 1.1
#define SX1272_SS 10 //For use with Lora Com Module
...
class SX1272
{
  ...
  public:
    ...
    */
    ...
    void SX1272::receivePacket(uint16_t wait, char** data, uint8_t* len, uint8_t* snr, int8_t* rssi);
